...
the exact nature of the k-mer comparisons has many computational benefits:
...
while the latter focus on computing the **similarity** of a query to other experiments,
the former focus on computing the **containment** of organisms
...
At the same time,
there is increasing pressure to the infrastructure for both storing and transferring the data in these public databases,
