...
focusing on an hierarchical approach optimized for storage access (`MHBT`)
...
assessments shows that `gather` paired with taxonomic information outperforms other
approaches,
