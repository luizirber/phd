...
CTBQ: where should we talk about how gather does not run into "k-mer saturation" problem that kraken style techniques run into?

### Limitations

CTBQ: these are limitations not of gather, but of scaled.
