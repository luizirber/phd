...
from GenBank.
Scaled MinHash sketches were calculated with $scaled=2000$ and $k=21$.
...
(ref:genbank-sizes-boxen) Letter-value plot [@hofmann_letter-value_2017] of _Scaled MinHash_
