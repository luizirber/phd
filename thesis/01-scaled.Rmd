...
\emph{mash screen} avoids repeated membership checks to a Bloom Filter by collecting all distinct hashes in the collection of reference MinHash sketches first,
...
```{r scaledGenBankSizes, eval=TRUE, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, cache=TRUE, fig.width=4, fig.cap="Scaled MinHash sketch sizes over GenBank domains"}
