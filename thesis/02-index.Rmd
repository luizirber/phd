...
MHBT support both containment and similarity queries.
For internal nodes the containment is used as a upper-bound of the similarity
$$J(Q, n) = \frac{\vert Q \cap n \vert }{\vert Q \cup n \vert}$$
since $\vert Q \cup n \vert \ge \vert Q \vert$.
When a leaf node is reached then the similarity $J(Q, S)$ is calculated for the
Scaled MinHash sketch $S$.
