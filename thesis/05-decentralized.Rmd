...
since it processes data submitted and accepted in GenBank.
...
One of the proposed solutions is moving to cloud computing resources as an alternative to a central repository with its own public funded infrastructure,
...
(on top of maintaining their own current infrastructure)
...
since both AWS and GCP have extensive infrastructure in place in their cloud offerings.
...
This increased dependency on companies that already monopolize much of the internet infrastructure also raise issues about competition,
...
<!-- TODO: [schneider_decentralization_2019] -->
<!-- TODO: [tsitsiklis_power_2011] A little centralization goes a long way -->
