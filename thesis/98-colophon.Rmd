...
The source files for this thesis, along with all the data files, have been organised into a git repository available at https://github.com/luizirber/phd. A hard copy of the thesis can be found in the University of California Davis library.
